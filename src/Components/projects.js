        ...
        <div>
          <div className="card-header">
            ...
            <div className="card-details">
              <h1>Gym</h1>
              <p>
                A Gym website to check workouts that will suit your fitness and
                find out what services we offer offer.
              </p>
          ...
          <div className="card-header">
            ...
            <div className="card-details">
              <h1>Netflix Clone</h1>
              <p>
                A spot on copy of the streaming servce Netflix library page and
          ...
          <div className="card-header">
            ...
            <div className="card-details">
              <h1>Tesla Clone</h1>
              <p>
                A tesla clone website to see different types vehicles and their
                informations ranging from speed to miles
              </p>
              <a
          ...
          <div className="card-header">
            ...
            <div className="card-details">
              <h1>Movie App</h1>
              <p>
                A movies website to explore and search for your favourite movies
                and get details about the movie{" "}
              </p>
              <a
          ...
          <div className="card-header">
            ...
            <div className="card-details">
              <h1>Amazon clone</h1>
              <p>
                An amazon clone shopping website to see your favourite items you
                can choose from and order
              </p>
              <a
